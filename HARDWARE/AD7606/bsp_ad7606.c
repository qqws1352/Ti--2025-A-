...
#define CONVST_1()	GPIOF->BSRRL = GPIO_Pin_5
#define CONVST_0()	GPIOF->BSRRH = GPIO_Pin_5
...
/* AD7606复位口线 : PI4  */
#define RESET_1()	GPIOF->BSRRL = GPIO_Pin_4
#define RESET_0()	GPIOF->BSRRH = GPIO_Pin_4
